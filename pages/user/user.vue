<template>
	<view class="user">
		...
		<view class="com-item">
			<view class="com-wrap">
				<view class="cell" @click="item.onclick" v-for="(item, index) in serverList" :key="index">
					<view class="cell-left">
						<image class="cell-icon" @click="() => console.log(item.onclick)" :src="item.icon" mode="aspectFill"></image>
						<view class="cell-text">{{ item.title }}</view>
					</view>
					<view class="iconfont iconmore1"></view>
				</view>
