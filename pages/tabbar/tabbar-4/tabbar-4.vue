<template>
    <view class="tabs">
			<uCharts chartType="arcbar" :opts="opts" cWidth="100" cHeight="100" canvasId="a1"></uCharts>
...
<script>
	...
	import uniappCircle from "@/components/uniapp-circle/uniapp-circle.vue"
	import uCharts from "@/js_sdk/u-charts/u-charts/component.vue"
    // 缓存每页最多
    ...
    export default {
	    components: {mediaItem, bertSwiper, bertTagGroup, uniSection, uniappCircle, uCharts},
        data() {
			return {
				opts: {"series":[{"name":"正确率","data":0.29,"color":"#2fc25b"}]},
				opts2: {"categories":["2013","2014","2015","2016","2017","2018"],"series":[{"name":"新成交量3","data":[35,36,31,33,13,34]},{"name":"新成交量4","data":[18,27,21,24,6,28]}]},
			    currentSection: {},
			    sectionList: [],
                newsList: [],
                cacheTab: [],
